...
$customer = querycustomer("SELECT * FROM m_customer");
// <!-- tambah customer -->
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <div class="container-fluid px-4 ">
                <h1 style="margin-top: -50px;">Data Customer <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-archive-fill" viewBox="0 0 16 16">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="deleteCustomer.php?id=<?php echo $row['id']; ?>" onclick=" return confirm('Yakin akan menghapus Data ini?')">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Customer Baru</h5>
            ...
            <div class="modal-body">
                <form method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Kode Customer" name="kode_cust" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nama Customer</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Nama Customer" name="name" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Telp Customer</label>
                        <input type="number" class="form-control" id="exampleInputPassword1" placeholder="Telp Customer" name="telp" required>
