...
$id = $_GET['id'];
$edit = query("SELECT * FROM m_barang WHERE id = $id")[0];
            ...
            <div class="container-fluid px-4 ">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Kode Barang" name="kode" value="<?= $edit['kode']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nama Barang</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Nama Barang" name="nama" value="<?= $edit['nama']; ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Harga Barang</label>
                        <input type="number" class="form-control" id="exampleInputPassword1" placeholder="Harga Barang" name="harga" value="<?= $edit['harga']; ?>" required>
                    </div>
